...
public class pentagon {
    public void pentagon(int a, int b, int c, int d, int e) {
        ...
        for(int i=-2*a;i<5*a;i+=a){
            for(int j=a-5*b;j<5*b;j+=b){
                for(int k=j-2*c;k<5*c;k+=c){
                    for(int m=k-2*d;m<5*d;m+=d){
                        if(v2*v3*v4*v5==0){
        ...
        for(int i=-2*b;i<5*b;i+=b){
            for(int j=b-5*c;j<10*c;j+=c){
                for(int k=j-5*d;k<10*d;k+=d){
                    if(v3*v4*v5==0){
        ...
        v4=0;
        v5=0;
        for(int i=-2*c;i<10*c;i+=c){
            for(int j=c-5*d;j<10*d;j+=d){
                if(v4*v5==0){
